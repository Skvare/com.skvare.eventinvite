 ...
 */
class CRM_Eventinvite_Upgrader_Base {

  /**
   * @var CRM_Eventinvite_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Eventinvite_Upgrader(
        'com.skvare.eventinvite',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Eventinvite_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Eventinvite_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
